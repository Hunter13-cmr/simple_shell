 ...
 **By Spencer Cheng, featuring Julien Barbier**
 Project to be done in teams of 2 people (your team: ELOCK SADRACK Fidele, Mostafa Farwiz Alaa)
...
git shortlog -se \
  ...
  > AUTHORS
  ELOCK SADRACK Fidele | @ELOCK_SADRACK_Fidele
  Mostafa Farwiz Alaa | @Mostafa_Farwiz_Alaa
